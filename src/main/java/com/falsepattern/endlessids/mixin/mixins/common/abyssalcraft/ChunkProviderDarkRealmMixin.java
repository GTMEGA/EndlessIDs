...
import com.shinoow.abyssalcraft.common.world.ChunkProviderDarkRealm;
...
@Mixin(value = ChunkProviderDarkRealm.class,
       remap = false)
public abstract class ChunkProviderDarkRealmMixin {
    @Shadow
