...
import matthbo.mods.darkworld.world.ChunkProviderDarkWorldAlpha;
...
@Mixin(value = ChunkProviderDarkWorldAlpha.class,
       remap = false)
public abstract class ChunkProviderDarkWorldAlphaMixin {
    @Shadow
    ...
    private byte[] setBiomesTweaked(Chunk chunk) {
        return BiomePatchHelper.getBiomeArrayTweaked(chunk, biomesForGen);
    }
}
