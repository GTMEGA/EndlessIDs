...
public abstract class MFQMDataWatcherMixin {
    @ModifyConstant(method = "preInit",
                    constant = {
                            @Constant(intValue = VanillaConstants.maxWatchableID, ordinal = 0),
                            @Constant(intValue = VanillaConstants.maxWatchableID, ordinal = 1),
                            @Constant(intValue = VanillaConstants.maxWatchableID, ordinal = 2)
                    },
                    require = 3)
