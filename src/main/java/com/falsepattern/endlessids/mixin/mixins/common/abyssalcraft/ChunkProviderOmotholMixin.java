...
import com.shinoow.abyssalcraft.common.world.ChunkProviderOmothol;
...
@Mixin(value = ChunkProviderOmothol.class,
       remap = false)
public abstract class ChunkProviderOmotholMixin {
    @Shadow
