...
public class DragonAPIModList implements IClassNodeTransformer {
    ...
    private static void tweakIsLoaded(MethodNode method) {
        ...
        iterator.next();
        iterator.next();
        iterator.set(new MethodInsnNode(Opcodes.INVOKESTATIC, Type.getInternalName(ASMHooks.class),
                                        "DragonAPIModListTryLoad", "(LReika/DragonAPI/ModList;)Z", false));
    }
    ...
    private static void tweakInit(MethodNode method) {
        ...
        while (iterator.hasNext()) {
            ...
            if (insn instanceof LineNumberNode && ((LineNumberNode) insn).line == 154) {
                ...
                iterator.add(new FieldInsnNode(Opcodes.PUTFIELD, "Reika/DragonAPI/ModList", "itemClasses",
                                               "[Ljava/lang/String;"));
                iterator.add(new VarInsnNode(Opcodes.ALOAD, 0));
                iterator.add(new VarInsnNode(Opcodes.ALOAD, 4));
                iterator.add(new FieldInsnNode(Opcodes.PUTFIELD, "Reika/DragonAPI/ModList", "blockClasses",
                                               "[Ljava/lang/String;"));
                iterator.next();
                iterator.remove();
                iterator.next();
                ...
                iterator.add(new FrameNode(Opcodes.F_FULL, 6,
                                           new Object[]{"Reika/DragonAPI/ModList", "java/lang/String", Opcodes.INTEGER,
                                                        "java/lang/String", "[Ljava/lang/String;",
                                                        "[Ljava/lang/String;"}, 0, new Object[]{}));
    ...
    public void transform(final ClassNode cn, final boolean obfuscated) {
        ...
        for (val method : cn.methods) {
            if ((state2 & 1) == 0 && method.name.equals("<init>") &&
                method.desc.equals("(Ljava/lang/String;ILjava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V")) {
                tweakInit(method);
                state2 |= 1;
            }
            if ((state2 & 2) == 0 && method.name.equals("isLoaded") && method.desc.equals("()Z")) {
